...
const SECTIONS: Section[] = [
  {
    slot: "GOLIATH",
    usage: "5× — dekoratív watermark (alacsony opacity 4-6%)",
    display: "·26·",
    ...
    samples: [
      ...
      {
        name: "Archivo Black",
        source: "Google Fonts · 1 weight",
        risk: "ofl",
        fontFamily: "var(--font-pv-archivo-black)",
        style: { fontWeight: 400 },
        note: "A 400 vizuálisan ~900-as. Legközelebb a Goliath tömbös súlyához.",
      },
      {
        name: "Bricolage Grotesque 800",
        source: "Google Fonts · variable 200-800",
        risk: "ofl",
      ...
      },
      {
        ...
        source: "Google Fonts · 1 weight",
        risk: "ofl",
        fontFamily: "var(--font-pv-anton)",
        style: { fontWeight: 400 },
        note: "Kondenzáltabb, plakát-feel.",
      },
    ],
  },
  {
    ...
    samples: [
      ...
      },
      {
        ...
        style: { fontWeight: 400 },
        note: "Modern terminal mono, Vercel saját font-ja. Legjobb match.",
      },
      {
        name: "JetBrains Mono",
        ...
        style: { fontWeight: 400 },
        note: "Kódolóknak tervezve, kicsit szélesebb karakterek.",
      },
      {
        name: "Space Grotesk",
        source: "Google Fonts · variable",
        risk: "ofl",
        fontFamily: "var(--font-pv-space-grotesk)",
        style: { fontWeight: 500 },
        note: "NEM mono, de futurisztikus, élesen rajzolt.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    samples: [
      ...
      },
      {
        ...
        source: "Google Fonts · 100-800",
        risk: "ofl",
        fontFamily: "var(--font-pv-sora)",
        style: { fontWeight: 700 },
        note: "Modern wide display, geometriai feel.",
      },
      {
        name: "Archivo Wide (wdth 125)",
        source: "Google Fonts · variable wdth",
        risk: "ofl",
